...
import training_data_to_tfrecords_3dcnn
...
if __name__ == '__main__':
    training_data_to_tfrecords_3dcnn_last.get_data_training(RAW_DATA_PATH, 'Train_3dcnn', TFRecord_DATA_PATH, TRAIN_ID)
    training_data_to_tfrecords_3dcnn.get_data_training(RAW_DATA_PATH, 'Train', TFRecord_DATA_PATH, TRAIN_ID)
