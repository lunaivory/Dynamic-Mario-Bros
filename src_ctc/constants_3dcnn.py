...
TRAIN_ID = range(1, 10)         # Raw file format : Sample0001.zip - Sample0470.zip
...
BATCH_SIZE = int(constants.BATCH_SIZE*constants.FRAMES_PER_VIDEO_PP/FRAMES_PER_CLIP) #30 # 5 gestures per batch
NUM_EPOCHS = 100000
